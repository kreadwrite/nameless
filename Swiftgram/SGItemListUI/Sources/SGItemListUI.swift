...
public enum SGItemListUIEntry<Section: SGItemListSection, BoolSetting: Hashable, SliderSetting: Hashable, OneFromManySetting: Hashable, DisclosureLink: Hashable, ActionType: Hashable>: ItemListNodeEntry {
    ...
    case toggleWithIcon(id: Int, section: Section, settingName: BoolSetting, value: Bool, text: String, iconRef: String, enabled: Bool)
    ...
    case reorderableRow(id: Int, section: Section, stableKey: ActionType, text: String, enabled: Bool)
    ...
    public static func ==(lhs: SGItemListUIEntry, rhs: SGItemListUIEntry) -> Bool {
        ...
        case let (.toggleWithIcon(id1, section1, settingName1, value1, text1, iconRef1, enabled1), .toggleWithIcon(id2, section2, settingName2, value2, text2, iconRef2, enabled2)):
            return id1 == id2 && section1 == section2 && settingName1 == settingName2 && value1 == value2 && text1 == text2 && iconRef1 == iconRef2 && enabled1 == enabled2
        ...
        case let (.delaySecondsSlider(id1, section1, settingName1, value1, left1, right1, center1), .delaySecondsSlider(id2, section2, settingName2, value2, left2, right2, center2)):
            return id1 == id2 && section1 == section2 && settingName1 == settingName2 && value1 == value2 && left1 == left2 && right1 == right2 && center1 == center2
        ...
        case let (.reorderableRow(id1, section1, stableKey1, text1, enabled1), .reorderableRow(id2, section2, stableKey2, text2, enabled2)):
            return id1 == id2 && section1 == section2 && stableKey1 == stableKey2 && text1 == text2 && enabled1 == enabled2
    ...
    public func item(presentationData: ItemListPresentationData, arguments: Any) -> ListViewItem {
        ...
        case let .delaySecondsSlider(_, _, setting, value, _, _, _):
            return SliderPercentageItem(
                theme: presentationData.theme,
                strings: presentationData.strings,
                value: value,
        ...
        case let .reorderableRow(_, _, stableKey, text, enabled):
...
public func filterSGItemListUIEntrires<Section: SGItemListSection & Hashable, BoolSetting: Hashable, SliderSetting: Hashable, OneFromManySetting: Hashable, DisclosureLink: Hashable, ActionType: Hashable>(
    ...
    func entryMatches(_ entry: SGItemListUIEntry<Section, BoolSetting, SliderSetting, OneFromManySetting, DisclosureLink, ActionType>, query: String) -> Bool {
        ...
        case .reorderableRow(_, _, _, let text, _):
            return text.lowercased().contains(query)
        }
    }
