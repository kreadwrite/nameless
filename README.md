...
- Скрытые legacy-вкладки Swiftgram/SwiftGram Pro, открываемые долгим нажатием.
...
- `Использовать наш логотип везде` - заменяет Telegram/Swiftgram-иконки на nameless-ассеты.
...
- `Whitegram AI *` - AI-блок под дальнейшую интеграцию.
...
- Ряд старых пунктов Swiftgram спрятан за long-press.
